...
HD_PWD='C:/FYP_160611/FYP/FYP.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log block_design1_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source block_design1_wrapper.tcl
