...
set Library     "hls"
set IPName      "freq_serial"
set Version     "1.0"
set DisplayName "block_simpleCounter"
set Revision    "1606130051"
set Description "block_simpleCounter"
set Device      "zynq"
...
set Interfaces {
    s_axi_FREQ_PERIPH_BUS {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_FREQ_PERIPH_BUS"
        param_prefix "C_S_AXI_FREQ_PERIPH_BUS"
        addr_bits "11"
        port_width "AWADDR 11 WDATA 32 WSTRB 4 ARADDR 11 RDATA 32"
        registers {{ 0x00 CTRL       RW   0x0 "Control signals"  {  { 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." }  { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." }  { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." }  { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." }  { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." }  { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." }  { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }  } }  { 0x04 GIER       RW   0x0 "Global Interrupt Enable Register"   {  { 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" }  { 1 30 RESERVED R 0 "Reserved.  0s on read." }  } }  { 0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register"   {  { 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." }  { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." }  { 2 30 RESERVED R 0 "Reserved.  0s on read." }  } }  { 0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register"   {  { 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" }  { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" }  { 2 30 RESERVED R 0 "Reserved.  0s on read." }  } } {0x600 seed_V W 0x0 "Data signal of seed_V" {{0 32 seed_V W 0 "Bit 31 to 0 Data signal of seed_V"}}} {0x608 n_V_1 W 0x0 "Data signal of n_V" {{0 32 n_V W 0 "Bit 31 to 0 Data signal of n_V"}}} {0x60c n_V_2 W 0x0 "Data signal of n_V" {{0 12 n_V W 0 "Bit 43 to 32 Data signal of n_V"} {12 20 RESERVED R 0 "Reserved.  0s on read."}}} {0x614 offset_V W 0x0 "Data signal of offset_V" {{0 1 offset_V W 0 "Bit 0 to 0 Data signal of offset_V"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories "freqStream_V {base_address 128 range 128} serialTwoStream_V {base_address 512 range 512} serialThreeStream_V {base_address 1024 range 512}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
...
## System Info
set user_parameters_list {clk_period 10.000000 machine 64 combinational 0 latency 344 II x}
...
set enable_xo_gen 0
set kernel_files {C:/Users/s02so/simpleCounter.cpp}
if {$enable_xo_gen} {
