...
#
# Generated by Vivado on Thu Jun 16 16:32:41 +0100 2016
# IP Build 1577682 on Fri Jun  3 12:00:54 MDT 2016 
#
# usage: block_design1.sh [-help]
# usage: block_design1.sh [-lib_map_path]
# usage: block_design1.sh [-noclean_files]
# usage: block_design1.sh [-reset_run]
#
...
# executing this script. Please type 'block_design1.sh -help' for more information.
#
...
# Script info
echo -e "block_design1.sh - Script generated by export_simulation (Vivado v2016.2 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/block_design1/ip/block_design1_processing_system7_0_0/sim/block_design1_processing_system7_0_0.v" \
  2>&1 | tee -a vlogan.log
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/block_design1/ip/block_design1_rst_processing_system7_0_100M_0/sim/block_design1_rst_processing_system7_0_100M_0.vhd" \
  2>&1 | tee -a vhdlan.log

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/block_design1/hdl/block_design1.v" \
    "$ref_dir/../../../ipstatic/freq_serial_v1_0/hdl/verilog/freq_serial.v" \
    "$ref_dir/../../../ipstatic/freq_serial_v1_0/hdl/verilog/freq_serial_FREQ_PERIPH_BUS_s_axi.v" \
    "$ref_dir/../../../ipstatic/freq_serial_v1_0/hdl/verilog/freq_serial_mux_112to1_sel7_43_1.v" \
    "$ref_dir/../../../ipstatic/freq_serial_v1_0/hdl/verilog/freq_serial_mux_32to1_sel5_44_1.v" \
    "$ref_dir/../../../ipstatic/freq_serial_v1_0/hdl/verilog/freq_serial_mux_96to1_sel7_43_1.v" \
    "$ref_dir/../../../bd/block_design1/ip/block_design1_freq_serial_0_3/sim/block_design1_freq_serial_0_3.v" \
  2>&1 | tee -a vlogan.log
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/block_design1/ip/block_design1_auto_pc_1/sim/block_design1_auto_pc_1.v" \
  2>&1 | tee -a vlogan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.block_design1 xil_defaultlib.glbl -o block_design1_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./block_design1_simv $vcs_sim_opts -do simulate.do
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./block_design1.sh -help\" for more information)\n"
        exit 1
      fi
...
reset_run()
{
  files_to_remove=(ucli.key block_design1_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc block_design1_simv.daidir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./block_design1.sh -help\" for more information)\n"
    exit 1
  fi
...
usage()
{
  msg="Usage: block_design1.sh [-help]\n\
Usage: block_design1.sh [-lib_map_path]\n\
Usage: block_design1.sh [-reset_run]\n\
Usage: block_design1.sh [-noclean_files]\n\n\
