...
HD_PWD='C:/FYP_160611/FYP_IP_Integrator_files/FYP.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log block_design1_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source block_design1_wrapper.tcl -notrace
