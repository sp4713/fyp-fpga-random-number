...
################################################################
# This is a generated script based on design: block_design1
#
...
# source block_design1_script.tcl
...
proc create_root_design { parentCell } {
  ...
  # Create instance: freq_serial_0, and set properties
  set freq_serial_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:freq_serial:1.0 freq_serial_0 ]
...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M00_AXI [get_bd_intf_pins freq_serial_0/s_axi_FREQ_PERIPH_BUS] [get_bd_intf_pins processing_system7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins freq_serial_0/ap_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_processing_system7_0_100M/ext_reset_in]
  connect_bd_net -net rst_processing_system7_0_100M_interconnect_aresetn [get_bd_pins processing_system7_0_axi_periph/ARESETN] [get_bd_pins rst_processing_system7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins freq_serial_0/ap_rst_n] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs freq_serial_0/s_axi_FREQ_PERIPH_BUS/Reg] SEG_freq_serial_0_Reg
...
preplace inst freq_serial_0 -pg 1 -lvl 1 -y 20 -defaultsOSRD
preplace inst rst_processing_system7_0_100M -pg 1 -lvl 2 -y 230 -defaultsOSRD
preplace inst processing_system7_0_axi_periph -pg 1 -lvl 3 -y 0 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 2 -y 430 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 2 2 NJ 230 NJ
preplace netloc processing_system7_0_axi_periph_M00_AXI 1 0 4 -10 110 NJ 110 NJ 120 1130
preplace netloc processing_system7_0_M_AXI_GP0 1 2 1 800
preplace netloc processing_system7_0_FCLK_RESET0_N 1 1 2 350 140 760
preplace netloc rst_processing_system7_0_100M_peripheral_aresetn 1 0 3 -20 -50 NJ -50 770
preplace netloc processing_system7_0_FIXED_IO 1 2 2 NJ 250 NJ
preplace netloc rst_processing_system7_0_100M_interconnect_aresetn 1 2 1 780
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 0 130 340 130 820
levelinfo -pg 1 -40 170 570 980 1550 -top -120 -bot 560
",
}
